...
namespace AlumnoEjemplos.Socketes
{
    public class TestParcialVS : TgcExample
    {
		...
		public TestParcialVS(string mediaDir, string shadersDir) : base(mediaDir, shadersDir)
        {
			Category = "SocketesTest";
			Name = "Test parcial VS";
        ...
        public override void Init()
        {
			...
			this.heightMap = TextureLoader.FromFile(D3DDevice.Instance.Device, ShadersDir + @"\WorkshopShaders\Media\Heighmaps\Heightmap6.jpg");
