...
* Permite aplicar iluminacion dinamica con PhongShading a nivel de pixel.
* Soporta hasta 4 luces por objeto en la misma pasada.
* Las luces tienen atenuacion por distancia.
* Solo se calcula el componente Diffuse para acelerar los calculos. Se ignora
* el Specular.
*/
