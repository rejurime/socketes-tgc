...
namespace AlumnoEjemplos.MiGrupo
{
    ...
    public class TestPelota : TgcExample
    {
        ...
        public override void init()
        {
            ...
            pelota = new Pelota();
            //Crear piso
            TgcTexture pisoTexture = TgcTexture.createTexture(GuiController.Instance.ExamplesMediaDir + "Texturas\\tierra.jpg");
            ...
            obstaculo = TgcBox.fromSize(
                ...
                TgcTexture.createTexture(GuiController.Instance.ExamplesMediaDir + "Texturas\\baldosaFacultad.jpg"));
            ...
            obstaculo = TgcBox.fromSize(
                ...
                TgcTexture.createTexture(GuiController.Instance.ExamplesMediaDir + "Texturas\\madera.jpg"));
            boundigboxs.Add(obstaculo.BoundingBox);
            boxs.Add(obstaculo);
